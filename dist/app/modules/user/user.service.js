...
const getUserProfileFromDB = (user) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const totalPigeons = yield pigeon_model_1.Pigeon.countDocuments({ createdBy: _id });
    return Object.assign(Object.assign({}, isExistUser.toObject()), { // mongoose document to plain object
