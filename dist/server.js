...
const subscriptonExpairs_1 = require("./helpers/cornJobs/subscriptonExpairs");
// uncaught exception
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            server = app_1.default.listen(port, config_1.default.ip_address, () => {
                logger_1.logger.info(colors_1.default.yellow(`♻️  Worker ${process.pid} listening on port:${config_1.default.port}`));
            });
            // socket.io
            ...
            //@ts-ignore
            (0, subscriptonExpairs_1.subscriptionExpiryCron)();
            global.io = io;
        }
        catch (error) {
